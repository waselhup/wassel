        ...
        <div className="lg:max-w-[820px] lg:mx-auto">
          ...
          <Card padding="lg" radius="lg" className="mb-4">
            ...
            <p className="font-ar text-[14px] leading-relaxed text-v2-body lg:text-[15px]">
              تحترم وصل خصوصيتك وتلتزم بحماية بياناتك الشخصية. توضح هذه السياسة كيفية جمع واستخدام وتخزين معلوماتك عند استخدام المنصّة، بما يتوافق مع نظام حماية البيانات الشخصية في المملكة العربية السعودية ولائحة GDPR الأوروبية.
            </p>
          </Card>
