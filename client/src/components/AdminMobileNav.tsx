...
import {
  ...
  Megaphone, Activity, HeartHandshake, TrendingUp, Microscope, ShieldCheck, X,
} from 'lucide-react';
 ...
 * Admin-only. 5 destinations + "More" bottom-sheet for overflow personas.
...
export default function AdminMobileNav() {
  ...
  return (
    <>
      ...
      {/* Bottom sheet with overflow personas */}
      <AnimatePresence>
        {moreOpen && (
          <>
            {/* Backdrop */}
